...
use crate::io::uring::IoUringSqe;

pub fn sqe_send(addr: usize, len: u32, user_data: usize) -> IoUringSqe {
    IoUringSqe { opcode: opcodes::SEND, addr, len, user_data, ..Default::default() }
}

pub fn sqe_recv(addr: usize, len: u32, user_data: usize) -> IoUringSqe {
