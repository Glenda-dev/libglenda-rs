...
pub const SCAN: usize = 1; // Trigger a background scan
pub const GET_SCAN_RESULTS: usize = 2; // Retrieve results
pub const CONNECT: usize = 3; // Associate with an AP
pub const DISCONNECT: usize = 4; // Disassociate
pub const GET_STATUS: usize = 5; // Get current connection info
