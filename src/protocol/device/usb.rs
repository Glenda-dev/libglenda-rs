...
// IPC Operations
pub const RESET_PORT: usize = 1; // arg0: port_id
pub const CONTROL_XFER: usize = 2; // arg0: address << 16 | endpoint
pub const BULK_XFER: usize = 3; // arg0: address << 16 | endpoint
pub const INTR_XFER: usize = 4;
